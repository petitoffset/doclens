...
DocLens is a lightweight retrieval-augmented generation (RAG) assistant for searching internal documents and answering questions with traceable sources. It is a focused technical-interview MVP designed to make the complete RAG path—and its limitations—easy to inspect and explain.
